...
{
  new (message_memory) vier_gewinnt::msg::Color(_init);
}

void Color_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vier_gewinnt::msg::Color *>(message_memory);
  typed_message->~Color();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Color_message_member_array[3] = {
  {
    ...
    offsetof(vier_gewinnt::msg::Color, r),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vier_gewinnt::msg::Color, g),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vier_gewinnt::msg::Color, b),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<vier_gewinnt::msg::Color>()
{
  return &::vier_gewinnt::msg::rosidl_typesupport_introspection_cpp::Color_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vier_gewinnt, msg, Color)() {
  return &::vier_gewinnt::msg::rosidl_typesupport_introspection_cpp::Color_message_type_support_handle;
}
