...
class Metaclass_SetPen(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from vier_gewinnt.srv import _set_pen
...
class SetPen(metaclass=Metaclass_SetPen):
    from vier_gewinnt.srv._set_pen import SetPen_Request as Request
    from vier_gewinnt.srv._set_pen import SetPen_Response as Response
