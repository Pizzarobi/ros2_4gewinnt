...
bool vier_gewinnt__srv__set_pen__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vier_gewinnt.srv._set_pen.SetPen_Request", full_classname_dest, 40) == 0);
  }
  vier_gewinnt__srv__SetPen_Request * ros_message = _ros_message;
  {  // r
...
PyObject * vier_gewinnt__srv__set_pen__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vier_gewinnt.srv._set_pen");
...
ROSIDL_GENERATOR_C_EXPORT
bool vier_gewinnt__srv__set_pen__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vier_gewinnt.srv._set_pen.SetPen_Response", full_classname_dest, 41) == 0);
  }
  vier_gewinnt__srv__SetPen_Response * ros_message = _ros_message;
