...
class Metaclass_Spawn(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from vier_gewinnt.srv import _spawn
...
class Spawn(metaclass=Metaclass_Spawn):
    from vier_gewinnt.srv._spawn import Spawn_Request as Request
    from vier_gewinnt.srv._spawn import Spawn_Response as Response
