...
static const _Spawn_Request_type_support_symbol_names_t _Spawn_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vier_gewinnt, srv, Spawn_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vier_gewinnt, srv, Spawn_Request)),
  }
};
...
{
  return &::vier_gewinnt::srv::rosidl_typesupport_cpp::Spawn_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vier_gewinnt, srv, Spawn_Request)() {
  return get_message_type_support_handle<vier_gewinnt::srv::Spawn_Request>();
}
...
static const _Spawn_Response_type_support_symbol_names_t _Spawn_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vier_gewinnt, srv, Spawn_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vier_gewinnt, srv, Spawn_Response)),
  }
};
...
{
  return &::vier_gewinnt::srv::rosidl_typesupport_cpp::Spawn_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vier_gewinnt, srv, Spawn_Response)() {
  return get_message_type_support_handle<vier_gewinnt::srv::Spawn_Response>();
}
...
static const _Spawn_type_support_symbol_names_t _Spawn_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vier_gewinnt, srv, Spawn)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vier_gewinnt, srv, Spawn)),
  }
};
...
{
  return &::vier_gewinnt::srv::rosidl_typesupport_cpp::Spawn_service_type_support_handle;
}
