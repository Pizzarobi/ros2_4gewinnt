...
#include "vier_gewinnt/action/detail/rotate_absolute__rosidl_typesupport_fastrtps_c.h"
...
#include "vier_gewinnt/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _RotateAbsolute_Goal__ros_msg_type = vier_gewinnt__action__RotateAbsolute_Goal;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vier_gewinnt
size_t get_serialized_size_vier_gewinnt__action__RotateAbsolute_Goal(
  const void * untyped_ros_message,
...
static uint32_t _RotateAbsolute_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vier_gewinnt__action__RotateAbsolute_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vier_gewinnt
size_t max_serialized_size_vier_gewinnt__action__RotateAbsolute_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _RotateAbsolute_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vier_gewinnt__action__RotateAbsolute_Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vier_gewinnt, action, RotateAbsolute_Goal)() {
...
using _RotateAbsolute_Result__ros_msg_type = vier_gewinnt__action__RotateAbsolute_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vier_gewinnt
size_t get_serialized_size_vier_gewinnt__action__RotateAbsolute_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RotateAbsolute_Result__ros_msg_type * ros_message = static_cast<const _RotateAbsolute_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_vier_gewinnt__action__RotateAbsolute_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vier_gewinnt
size_t max_serialized_size_vier_gewinnt__action__RotateAbsolute_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _RotateAbsolute_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vier_gewinnt__action__RotateAbsolute_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vier_gewinnt, action, RotateAbsolute_Result)() {
...
using _RotateAbsolute_Feedback__ros_msg_type = vier_gewinnt__action__RotateAbsolute_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vier_gewinnt
size_t get_serialized_size_vier_gewinnt__action__RotateAbsolute_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RotateAbsolute_Feedback__ros_msg_type * ros_message = static_cast<const _RotateAbsolute_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_vier_gewinnt__action__RotateAbsolute_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vier_gewinnt
size_t max_serialized_size_vier_gewinnt__action__RotateAbsolute_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _RotateAbsolute_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vier_gewinnt__action__RotateAbsolute_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vier_gewinnt, action, RotateAbsolute_Feedback)() {
...
// already included above
// #include "vier_gewinnt/action/detail/rotate_absolute__functions.h"  // goal

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_vier_gewinnt
...
using _RotateAbsolute_SendGoal_Request__ros_msg_type = vier_gewinnt__action__RotateAbsolute_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, vier_gewinnt, action, RotateAbsolute_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vier_gewinnt
size_t get_serialized_size_vier_gewinnt__action__RotateAbsolute_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RotateAbsolute_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _RotateAbsolute_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_vier_gewinnt__action__RotateAbsolute_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_vier_gewinnt__action__RotateAbsolute_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vier_gewinnt
size_t max_serialized_size_vier_gewinnt__action__RotateAbsolute_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_vier_gewinnt__action__RotateAbsolute_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _RotateAbsolute_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vier_gewinnt__action__RotateAbsolute_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vier_gewinnt, action, RotateAbsolute_SendGoal_Request)() {
...
using _RotateAbsolute_SendGoal_Response__ros_msg_type = vier_gewinnt__action__RotateAbsolute_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vier_gewinnt
size_t get_serialized_size_vier_gewinnt__action__RotateAbsolute_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RotateAbsolute_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _RotateAbsolute_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_vier_gewinnt__action__RotateAbsolute_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vier_gewinnt
size_t max_serialized_size_vier_gewinnt__action__RotateAbsolute_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _RotateAbsolute_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vier_gewinnt__action__RotateAbsolute_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vier_gewinnt, action, RotateAbsolute_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vier_gewinnt, action, RotateAbsolute_SendGoal)() {
...
using _RotateAbsolute_GetResult_Request__ros_msg_type = vier_gewinnt__action__RotateAbsolute_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vier_gewinnt
size_t get_serialized_size_vier_gewinnt__action__RotateAbsolute_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RotateAbsolute_GetResult_Request__ros_msg_type * ros_message = static_cast<const _RotateAbsolute_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_vier_gewinnt__action__RotateAbsolute_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vier_gewinnt
size_t max_serialized_size_vier_gewinnt__action__RotateAbsolute_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _RotateAbsolute_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vier_gewinnt__action__RotateAbsolute_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vier_gewinnt, action, RotateAbsolute_GetResult_Request)() {
...
// already included above
// #include "vier_gewinnt/action/detail/rotate_absolute__functions.h"  // result
...
using _RotateAbsolute_GetResult_Response__ros_msg_type = vier_gewinnt__action__RotateAbsolute_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, vier_gewinnt, action, RotateAbsolute_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vier_gewinnt
size_t get_serialized_size_vier_gewinnt__action__RotateAbsolute_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RotateAbsolute_GetResult_Response__ros_msg_type * ros_message = static_cast<const _RotateAbsolute_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_vier_gewinnt__action__RotateAbsolute_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_vier_gewinnt__action__RotateAbsolute_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vier_gewinnt
size_t max_serialized_size_vier_gewinnt__action__RotateAbsolute_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_vier_gewinnt__action__RotateAbsolute_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _RotateAbsolute_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vier_gewinnt__action__RotateAbsolute_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vier_gewinnt, action, RotateAbsolute_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vier_gewinnt, action, RotateAbsolute_GetResult)() {
...
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
// already included above
// #include "vier_gewinnt/action/detail/rotate_absolute__functions.h"  // feedback
...
using _RotateAbsolute_FeedbackMessage__ros_msg_type = vier_gewinnt__action__RotateAbsolute_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, vier_gewinnt, action, RotateAbsolute_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vier_gewinnt
size_t get_serialized_size_vier_gewinnt__action__RotateAbsolute_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RotateAbsolute_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _RotateAbsolute_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_vier_gewinnt__action__RotateAbsolute_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_vier_gewinnt__action__RotateAbsolute_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vier_gewinnt
size_t max_serialized_size_vier_gewinnt__action__RotateAbsolute_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_vier_gewinnt__action__RotateAbsolute_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _RotateAbsolute_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vier_gewinnt__action__RotateAbsolute_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vier_gewinnt, action, RotateAbsolute_FeedbackMessage)() {
