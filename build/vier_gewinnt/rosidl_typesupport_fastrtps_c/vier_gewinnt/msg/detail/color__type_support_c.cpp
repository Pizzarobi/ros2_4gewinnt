...
#include "vier_gewinnt/msg/detail/color__rosidl_typesupport_fastrtps_c.h"
...
using _Color__ros_msg_type = vier_gewinnt__msg__Color;
...
size_t get_serialized_size_vier_gewinnt__msg__Color(
  const void * untyped_ros_message,
...
static uint32_t _Color__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vier_gewinnt__msg__Color(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vier_gewinnt
size_t max_serialized_size_vier_gewinnt__msg__Color(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Color__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vier_gewinnt__msg__Color(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vier_gewinnt, msg, Color)() {
