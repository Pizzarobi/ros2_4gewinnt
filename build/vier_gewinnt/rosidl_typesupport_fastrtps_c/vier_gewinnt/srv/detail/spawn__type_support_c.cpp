...
#include "vier_gewinnt/srv/detail/spawn__rosidl_typesupport_fastrtps_c.h"
...
using _Spawn_Request__ros_msg_type = vier_gewinnt__srv__Spawn_Request;
...
size_t get_serialized_size_vier_gewinnt__srv__Spawn_Request(
  const void * untyped_ros_message,
...
static uint32_t _Spawn_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vier_gewinnt__srv__Spawn_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vier_gewinnt
size_t max_serialized_size_vier_gewinnt__srv__Spawn_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Spawn_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vier_gewinnt__srv__Spawn_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vier_gewinnt, srv, Spawn_Request)() {
...
using _Spawn_Response__ros_msg_type = vier_gewinnt__srv__Spawn_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vier_gewinnt
size_t get_serialized_size_vier_gewinnt__srv__Spawn_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Spawn_Response__ros_msg_type * ros_message = static_cast<const _Spawn_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_vier_gewinnt__srv__Spawn_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vier_gewinnt
size_t max_serialized_size_vier_gewinnt__srv__Spawn_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Spawn_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vier_gewinnt__srv__Spawn_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vier_gewinnt, srv, Spawn_Response)() {
...
// already included above
// #include "vier_gewinnt/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "vier_gewinnt/srv/spawn.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vier_gewinnt, srv, Spawn)() {
