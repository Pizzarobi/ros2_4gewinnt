...
#include "vier_gewinnt/msg/detail/color__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const vier_gewinnt::msg::Color *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vier_gewinnt::msg::Color *>(
    untyped_ros_message);
...
{
  return &vier_gewinnt::msg::typesupport_fastrtps_cpp::_Color__handle;
}
