...
#include "vier_gewinnt/msg/detail/pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vier_gewinnt::msg::Pose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vier_gewinnt::msg::Pose & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
...
{
  auto typed_message =
    static_cast<const vier_gewinnt::msg::Pose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vier_gewinnt::msg::Pose *>(
    untyped_ros_message);
...
{
  return &vier_gewinnt::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vier_gewinnt, msg, Pose)() {
  return &vier_gewinnt::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
