...
#include "vier_gewinnt/srv/detail/teleport_relative__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const vier_gewinnt::srv::TeleportRelative_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vier_gewinnt::srv::TeleportRelative_Request *>(
    untyped_ros_message);
...
{
  return &vier_gewinnt::srv::typesupport_fastrtps_cpp::_TeleportRelative_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const vier_gewinnt::srv::TeleportRelative_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<vier_gewinnt::srv::TeleportRelative_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &vier_gewinnt::srv::typesupport_fastrtps_cpp::_TeleportRelative_Response__handle;
}
...
{
  return &vier_gewinnt::srv::typesupport_fastrtps_cpp::_TeleportRelative__handle;
}
