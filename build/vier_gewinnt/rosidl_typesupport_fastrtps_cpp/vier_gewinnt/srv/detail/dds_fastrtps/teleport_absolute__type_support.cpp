...
#include "vier_gewinnt/srv/detail/teleport_absolute__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vier_gewinnt::srv::TeleportAbsolute_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vier_gewinnt::srv::TeleportAbsolute_Request & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
...
{
  auto typed_message =
    static_cast<const vier_gewinnt::srv::TeleportAbsolute_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vier_gewinnt::srv::TeleportAbsolute_Request *>(
    untyped_ros_message);
...
{
  return &vier_gewinnt::srv::typesupport_fastrtps_cpp::_TeleportAbsolute_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vier_gewinnt, srv, TeleportAbsolute_Request)() {
  return &vier_gewinnt::srv::typesupport_fastrtps_cpp::_TeleportAbsolute_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_vier_gewinnt
cdr_serialize(
  const vier_gewinnt::srv::TeleportAbsolute_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vier_gewinnt::srv::TeleportAbsolute_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const vier_gewinnt::srv::TeleportAbsolute_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<vier_gewinnt::srv::TeleportAbsolute_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &vier_gewinnt::srv::typesupport_fastrtps_cpp::_TeleportAbsolute_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vier_gewinnt, srv, TeleportAbsolute_Response)() {
  return &vier_gewinnt::srv::typesupport_fastrtps_cpp::_TeleportAbsolute_Response__handle;
}
...
{
  return &vier_gewinnt::srv::typesupport_fastrtps_cpp::_TeleportAbsolute__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vier_gewinnt, srv, TeleportAbsolute)() {
  return &vier_gewinnt::srv::typesupport_fastrtps_cpp::_TeleportAbsolute__handle;
}
