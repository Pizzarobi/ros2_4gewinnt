...
#ifndef VIER_GEWINNT__SRV__DETAIL__KILL__FUNCTIONS_H_
#define VIER_GEWINNT__SRV__DETAIL__KILL__FUNCTIONS_H_
 ...
 * calls
 * vier_gewinnt__srv__Kill_Request__init().
...
/**
 * It calls
 * vier_gewinnt__srv__Kill_Request__fini()
 ...
 * vier_gewinnt__srv__Kill_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * vier_gewinnt__srv__Kill_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * vier_gewinnt__srv__Kill_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vier_gewinnt
...
/**
 * It calls
 * vier_gewinnt__srv__Kill_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_vier_gewinnt
...
/**
 * It allocates the memory for the array and calls
 * vier_gewinnt__srv__Kill_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vier_gewinnt
...
/**
 * It calls
 * vier_gewinnt__srv__Kill_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // VIER_GEWINNT__SRV__DETAIL__KILL__FUNCTIONS_H_
