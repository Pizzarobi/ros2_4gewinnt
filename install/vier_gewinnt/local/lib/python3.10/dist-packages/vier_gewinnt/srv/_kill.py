...
class Metaclass_Kill(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from vier_gewinnt.srv import _kill
...
class Kill(metaclass=Metaclass_Kill):
    from vier_gewinnt.srv._kill import Kill_Request as Request
    from vier_gewinnt.srv._kill import Kill_Response as Response
