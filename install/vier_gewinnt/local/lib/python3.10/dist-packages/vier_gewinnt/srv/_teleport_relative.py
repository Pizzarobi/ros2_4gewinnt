...
class Metaclass_TeleportRelative(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vier_gewinnt.srv.TeleportRelative')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from vier_gewinnt.srv import _teleport_relative
...
class TeleportRelative(metaclass=Metaclass_TeleportRelative):
    from vier_gewinnt.srv._teleport_relative import TeleportRelative_Request as Request
    from vier_gewinnt.srv._teleport_relative import TeleportRelative_Response as Response
