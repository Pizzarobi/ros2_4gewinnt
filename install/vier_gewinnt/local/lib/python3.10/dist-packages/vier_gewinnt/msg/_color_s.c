...
bool vier_gewinnt__msg__color__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vier_gewinnt.msg._color.Color", full_classname_dest, 29) == 0);
  }
  vier_gewinnt__msg__Color * ros_message = _ros_message;
  {  // r
...
PyObject * vier_gewinnt__msg__color__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vier_gewinnt.msg._color");
